...
description: Fetch the highest-priority Linear issue, create a git branch, assist development with human-in-the-loop, commit, push, and update Linear status. Use when the user says "move to the next", "start dev", or wants to begin working on the next Linear issue.
---
...
- "finish developing" / "done" / "commit code" / "commit"
...
**WAIT**: Both must pass. Ask user: "Lint and test have all passed. Shall we continue to submit?"
