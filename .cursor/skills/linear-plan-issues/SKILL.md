...
description: Parse discussed requirements and create Linear issues with standardized title format [px][type][module]. Use when the user finishes discussing a feature, bug, or improvement and wants to write it into Linear, or says "update Linear issues", "创建需求", "记录issue", "plan issues".
---
